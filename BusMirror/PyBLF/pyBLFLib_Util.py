...
class BL_OBJ_TYPE(c_uint32):
    ...
    # BL_OBJ_TYPE_FUNCTION_BUS = 124 # #OBSOLETE
    BL_OBJ_TYPE_COMMUNICATION_OBJECT = 124 #Communication object in the communication setup
    ...
    _enum_map = {
        ...
        124: "BL_OBJ_TYPE_COMMUNICATION_OBJECT",
...
class  VBLEthernetFrameForwarded(Structure):
    _fields_=[
        ("mHeader",        VBLObjectHeader),
        ("mStructLength",        c_uint16),        # Length of this structure, without sizeof(VBLObjectHeader), without mStructLength member and without mFrameData member
        ("mFlags",        c_uint16),        # flags, which indicates the valid fields:
        ("mChannel",        c_uint16),        # application channel, i.e. Eth 1
        ("mHardwareChannel",        c_uint16),        # HW channel
        ("mFrameDuration",        c_uint64),        # Transmission duration in [ns]
        ("mFrameChecksum",        c_uint32),        # Ethernet checksum
        ("mDir",        c_uint16),        # Direction flag: 0=Rx, 1=Tx, 2=TxRq
        ("mFrameLength",        c_uint16),        # Number of valid mFrameData bytes
        ("mFrameHandle",        c_uint32),        # Handle which refer the corresponding VBLEthernetFrameForwarded event
        ("mReserved",        c_uint32),
        ("mFrameData",        POINTER(c_uint8)),        # Max 1612 data bytes per frame. Contains Ethernet header + Ethernet payload
]
...
class  VBLEthernetErrorForwarded(Structure):
    _fields_=[
        ("mHeader",        VBLObjectHeader),
        ("mStructLength",        c_uint16),        # Length of this structure, without sizeof(VBLObjectHeader), without mStructLength member and without mFrameData member
        ("mFlags",        c_uint16),        # flags, which indicates the valid fields:
        ...
        ("mDir",        c_uint16),        # Direction flag: 0=Rx, 1=Tx, 2=TxRq
        ("mFrameLength",        c_uint16),        # Number of valid mFrameData bytes
        ("mFrameHandle",        c_uint32),        # Handle which refer the corresponding VBLEthernetErrorEx event
        ("mError",        c_uint32),
        ("mFrameData",        POINTER(c_uint8)),        # Max 1612 data bytes per frame. Contains Ethernet header + Ethernet payload
]
...
# 类型到结构体的映射
BL_OBJ_TYPE_TO_STRUCTURE: Dict[int, Type[Structure]] = {
    BL_OBJ_TYPE.BL_OBJ_SIGNATURE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_UNKNOWN: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_MESSAGE: VBLCANMessage,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_ERROR: VBLCANErrorFrame,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_OVERLOAD: VBLCANOverloadFrame,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_STATISTIC: VBLCANDriverStatistic,
    BL_OBJ_TYPE.BL_OBJ_TYPE_APP_TRIGGER: VBLAppTrigger,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ENV_INTEGER: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ENV_DOUBLE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ENV_STRING: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ENV_DATA: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LOG_CONTAINER: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_MESSAGE: VBLLINMessage,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_CRC_ERROR: VBLLINCRCError,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_DLC_INFO: VBLLINDLCInfo,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_RCV_ERROR: VBLLINReceiveError,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SND_ERROR: VBLLINSendError,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SLV_TIMEOUT: VBLLINSlaveTimeout,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SCHED_MODCH: VBLLINSchedulerModeChange,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SYN_ERROR: VBLLINSyncError,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_BAUDRATE: VBLLINBaudrateEvent,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SLEEP: VBLLINSleepModeEvent,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_WAKEUP: VBLLINWakeupEvent,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_SPY: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_CTRL: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_LIGHTLOCK: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_STATISTIC: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_1: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_2: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_3: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FLEXRAY_DATA: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FLEXRAY_SYNC: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_DRIVER_ERROR: VBLCANDriverError,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_PKT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_PKT2: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_HWMODE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_REG: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_GENREG: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_NETSTATE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_DATALOST: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_TRIGGER: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FLEXRAY_CYCLE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FLEXRAY_MESSAGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_CHECKSUM_INFO: VBLLINChecksumInfo,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SPIKE_EVENT: VBLLINSpikeEvent,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_DRIVER_SYNC: VBLCANDriverHwSync,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FLEXRAY_STATUS: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_GPS_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FR_ERROR: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FR_STATUS: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FR_STARTCYCLE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FR_RCVMESSAGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_REALTIMECLOCK: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AVAILABLE2: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AVAILABLE3: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_STATISTIC: VBLLINStatisticEvent,
    BL_OBJ_TYPE.BL_OBJ_TYPE_J1708_MESSAGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_J1708_VIRTUAL_MSG: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_MESSAGE2: VBLLINMessage2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SND_ERROR2: VBLLINSendError2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SYN_ERROR2: VBLLINSyncError2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_CRC_ERROR2: VBLLINCRCError2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_RCV_ERROR2: VBLLINReceiveError2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_WAKEUP2: VBLLINWakeupEvent2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SPIKE_EVENT2: VBLLINSpikeEvent2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_LONG_DOM_SIG: VBLLINLongDomSignalEvent,
    BL_OBJ_TYPE.BL_OBJ_TYPE_APP_TEXT: VBLAppText,
    BL_OBJ_TYPE.BL_OBJ_TYPE_FR_RCVMESSAGE_EX: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_STATISTICEX: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_TXLIGHT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_ALLOCTAB: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_STRESS: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_FRAME: VBLEthernetFrame,
    BL_OBJ_TYPE.BL_OBJ_TYPE_SYS_VARIABLE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_ERROR_EXT: VBLCANErrorFrameExt,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_DRIVER_ERROR_EXT: VBLCANDriverErrorExt,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_LONG_DOM_SIG2: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_150_MESSAGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_150_PKT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_ETHERNET_PKT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_150_MESSAGE_FRAGMENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_150_PKT_FRAGMENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_ETHERNET_PKT_FRAGMENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_SYSTEM_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_150_ALLOCTAB: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_50_MESSAGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_50_PKT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_MESSAGE2: VBLCANMessage2,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_UNEXPECTED_WAKEUP: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SHORT_OR_SLOW_RESPONSE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_DISTURBANCE_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_SERIAL_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_OVERRUN_ERROR: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_EVENT_COMMENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_WLAN_FRAME: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_WLAN_STATISTIC: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_MOST_ECL: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_GLOBAL_MARKER: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AFDX_FRAME: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AFDX_STATISTIC: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_KLINE_STATUSEVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_FD_MESSAGE: VBLCANFDMessage,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_FD_MESSAGE_64: VBLCANFDMessage64,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_RX_ERROR: VBLEthernetRxError,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_STATUS: VBLEthernetStatus,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_FD_ERROR_64: VBLCANFDErrorFrame64,
    BL_OBJ_TYPE.BL_OBJ_TYPE_LIN_SHORT_OR_SLOW_RESPONSE2: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AFDX_STATUS: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AFDX_BUS_STATISTIC: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_4: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_AFDX_ERROR_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_A429_ERROR: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_A429_STATUS: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_A429_BUS_STATISTIC: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_A429_MESSAGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_STATISTIC: VBLEthernetStatistic,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_5: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_6: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_reserved_7: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_TEST_STRUCTURE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_DIAG_REQUEST_INTERPRETATION: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_FRAME_EX: VBLEthernetFrameEx,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_FRAME_FORWARDED: VBLEthernetFrameForwarded,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_ERROR_EX: VBLEthernetErrorEx,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_ERROR_FORWARDED: VBLEthernetErrorForwarded,
    # BL_OBJ_TYPE.BL_OBJ_TYPE_FUNCTION_BUS: None, # #OBSOLETE
    BL_OBJ_TYPE.BL_OBJ_TYPE_COMMUNICATION_OBJECT: None, #Communication object in the communication setup
    BL_OBJ_TYPE.BL_OBJ_TYPE_DATA_LOST_BEGIN: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_DATA_LOST_END: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_WATER_MARK_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_TRIGGER_CONDITION: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_CAN_SETTING_CHANGED: VBLCANSettingsChanged,
    BL_OBJ_TYPE.BL_OBJ_TYPE_DISTRIBUTED_OBJECT_MEMBER: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ATTRIBUTE_EVENT: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_DISTRIBUTED_OBJECT_CHANGE: None,
    BL_OBJ_TYPE.BL_OBJ_TYPE_ETHERNET_PHY_STATE: VBLEthernetPhyState,

}


'''
######################################Auto Creat Structure####################################
'''


def Create_BL_OBJ_By_Type(obj_type: int) -> Optional[Structure]:
    bl_obj = BL_OBJ_TYPE_TO_STRUCTURE.get(obj_type)
    if bl_obj is None:
        return None
    return bl_obj()
